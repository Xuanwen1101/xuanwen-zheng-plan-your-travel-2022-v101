    ...
    <body>
        <header class="header">
            ...
            <nav class="header__nav">
              <ul class="nav__wrapper">
                ...
                <li class="nav__item"><a href="/console/login">Log In</a></li>
              </ul>
            </nav>
        </header>
        ...
        <section class="w3-padding main">
            ...
            <div class="objects-container">
              <form method="post" action="/console/users/register" novalidate class="form">
                  <?= csrf_field() ?>
            ...
            <div class="object__link">
              <a href="/console/login">Back to Log In Page</a>
            </div>
